...
namespace stationeers::ic10 {
    ...
    void initToken(py::module_& m) {
        ...
        py::enum_<TokenType>(m, "TokenType")
            ...
            .value("DOC_COMMENT", TokenType::DOC_COMMENT)
            .value("TYPE_HINT", TokenType::TYPE_HINT)
            ...
            .value("KEYWORD_RGAS", TokenType::KEYWORD_RGAS)
            ...
            .value("KEYWORD_CLRD", TokenType::KEYWORD_CLRD)
            ...
            .value("KEYWORD_SGN", TokenType::KEYWORD_SGN)
            ...
            .value("KEYWORD_BRNEZ", TokenType::KEYWORD_BRNEZ)
            ...
            .value("KEYWORD_ROL", TokenType::KEYWORD_ROL)
            .value("KEYWORD_ROR", TokenType::KEYWORD_ROR)
            ...
            .value("KEYWORD_CLAMP", TokenType::KEYWORD_CLAMP)
        ...
        py::enum_<TokenCategory>(m, "TokenCategory")
            ...
            .value("ANNOTATION", TokenCategory::ANNOTATION)
