...
#define IC10_COMPILER_LOCAL_MSG_EN_US(id, msg) IC10_COMPILER_LOCAL_MSG(EnUs, id, msg)
    ...
    IC10_COMPILER_LOCAL_MSG_EN_US(IEP17, "Missing operand - syntax analysis.")
    IC10_COMPILER_LOCAL_MSG_EN_US(IEP18, "Missing register or device - syntax analysis.")
    IC10_COMPILER_LOCAL_MSG_EN_US(IEP19, "Missing register or identifier - syntax analysis.")
    IC10_COMPILER_LOCAL_MSG_EN_US(IEP20, "Missing device reference - syntax analysis.")
    IC10_COMPILER_LOCAL_MSG_EN_US(IEP21, "Missing macro call - syntax analysis.")
    IC10_COMPILER_LOCAL_MSG_EN_US(IEP22, "Missing identifier or number - syntax analysis.")
    IC10_COMPILER_LOCAL_MSG_EN_US(IEP23, "Missing colon after label - syntax analysis.")
    IC10_COMPILER_LOCAL_MSG_EN_US(IEP24, "Missing alias keyword - syntax analysis.")
    IC10_COMPILER_LOCAL_MSG_EN_US(IEP25, "Missing define keyword - syntax analysis.")
    ...
    IC10_COMPILER_LOCAL_MSG_EN_US(IEA5_1, "Constant '{}' has been redefined - semantic analysis.")
