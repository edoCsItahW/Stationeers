...
Copy-Artifact -Source "$PSScriptRoot/../../IC10/backend/compiler/publish/node/src/ic10c-node.node" -Destination "$PSScriptRoot/../../IC10/plugins/vscode/ic10-language-support/node_modules/@ic10/compiler/src/ic10c-node.node" -Force
