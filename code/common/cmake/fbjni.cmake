...
# ============================================================================
#
# fbjni 默认构建为 SHARED 库，这会导致 ic10c_java.dll 在运行时依赖
# fbjni.dll。为了让 fbjni 静态链接进 ic10c_java.dll（简化分发），
# 这里在获取源码后将 CMakeLists.txt 中的 SHARED 改为 STATIC。

include(FetchContent)

# 检查是否已经存在，避免重复（fbjni.cmake 可能被 common_java 和 IC10_Compiler_Java 各 include 一次）
if(NOT TARGET fbjni)
    ...
    # 将 fbjni 从 SHARED 改为 STATIC，使其静态链接到 ic10c_java.dll
    ...
    # 代码（如 ic10c_java、common_java）都看到 __declspec(dllexport) 而非 dllimport。
