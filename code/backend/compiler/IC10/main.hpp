 ...
 *     ic10::OperandType::REG_IDENT,      // 目标寄存器: r0, r1, ...
 *     ic10::OperandType::REG_NUM,        // 源寄存器1: 0, 1, ...
 *     ic10::OperandType::REG_NUM         // 源寄存器2: 0, 1, ...
 * )
 * ```
 *
 * **类型安全的优势**：
 ...
 * DEFINE_TERNARY_INSTRUCTION(add, Add, ADD,
 *     ic10::OperandType::REG_IDENT,      // Target: r0, r1, ...
 *     ic10::OperandType::REG_NUM,        // Source 1: 0, 1, ...
 *     ic10::OperandType::REG_NUM         // Source 2: 0, 1, ...
 * )
 * ```
 *
 ...
 *
 * @code{.cpp}
 * #include "ic10/linker/linker.hpp"
 *
 * using namespace stationeers::ic10;
 *
 * // 创建链接器
