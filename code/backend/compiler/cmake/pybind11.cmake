...
if(NOT pybind11_DIR)
    message(STATUS "pybind11.cmake: Attempting to detect pybind11 via Python...")
    execute_process(
    ...
    if(_PYBIND11_RESULT EQUAL 0 AND _PYBIND11_CMAKE_DIR)
        ...
        message(STATUS "pybind11.cmake: auto-detected pybind11_DIR = ${pybind11_DIR}")
    else()
...
if(NOT TARGET pybind11::pybind11)
    message(FATAL_ERROR "pybind11::pybind11 target not created. Please install pybind11 (`pip install pybind11`) or set pybind11_DIR.")
endif()
...
message(STATUS "pybind11.cmake <NOTE>: The target 'pybind11::pybind11' automatically provides Python headers and libraries")